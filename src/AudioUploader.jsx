  ...
  return (
    <section aria-labelledby="upload-heading" style={{ maxWidth: '400px', margin: '0 auto', padding: '1rem' }}>
      ...
      {trackName && (
       ...
       <p style={{marginTop: '20px', fontSize: '14px'}}>If you are on iOS spend the $2 on <a href="https://apps.apple.com/us/app/skateloops-mp3-practice-app/id6476055748">the SkateLoops App</a> by Shauna Lynn. It's better, trust me!! </p><p style={{marginTop: '20px', fontSize: '14px'}}> This is just to tide us over until she gets around to releasing an Android version. Anytime we mess with native device audio playback on the web, it just isn't going to be as good as what's possible on a native app</p>
